...
#include <cassert>
#include <cmath>
//#include <cstdlib> -- commented out and nothing failed to compile, maybe not needed
#include <cstdio>
#include <cstring>
//#include "memory.h" -- commented out and nothing failed to compile, maybe not needed
#include <fstream>
